...
<head>
    ...
    <title>Pariwisata - SIP PESANGGRAHAN</title>
...
<body class="bg-light">
    ...
    <div class="page-header shadow-sm">
        <div class="container">
            ...
            <p class="lead mb-0 opacity-75">Jelajahi keindahan ruang publik, sejarah lokal, dan destinasi ikonik di Pesanggrahan</p>
        </div>
    </div>
