...
<head>
    ...
    <title>Aparatur Kelurahan - SIP PESANGGRAHAN</title>
    ...
    <style>
        ...
        /* Navbar Styling (Sama seperti welcome.blade.php) */
        ...
        /* Header Gambar Spesifik untuk Halaman Ini */
        .page-header {
...
<body class="bg-light">
    ...
    <div class="page-header shadow-sm">
        <div class="container">
            <h1 class="display-5 fw-bold mb-3">Aparatur Kelurahan</h1>
            <p class="lead mb-0 opacity-75">Mengenal lebih dekat para pelayan masyarakat di Kelurahan Pesanggrahan</p>
        </div>
    </div>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-3 text-center">
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100">
                    <div style="height: 300px; background: #e9ecef; position: relative;">
                        @if($a->foto)
                            <img src="{{ asset('storage/' . $a->foto) }}" class="w-100 h-100" style="object-fit: cover; object-position: top;" alt="{{ $a->nama }}">
                        @else
                            <div class="d-flex justify-content-center align-items-center h-100">
                                <i class="bi bi-person-fill text-secondary opacity-50" style="font-size: 6rem;"></i>
                            </div>
                        @endif
                    </div>
                    <div class="card-body">
                        <h6 class="fw-bold text-primary mb-1">{{ $a->nama }}</h6>
                        <p class="small text-muted mb-0 fw-semibold">{{ $a->jabatan }}</p>
                    </div>
                </div>
            </div>
            @empty
            <div class="col-12 text-center py-5">
                ...
                <p class="text-muted mt-3">Data aparatur belum ditambahkan oleh Admin.</p>
            </div>
            @endforelse
        </div>
    </div>
